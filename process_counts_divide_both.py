...
#Section 4: Transform the PTR layer by the genome length
PTR_df = adata_PTR_trans.to_df()
PTR_df = PTR_df * len_series
adata_PTR_trans = anndata.AnnData(PTR_df)


#Section 5: Combine into AnnData
